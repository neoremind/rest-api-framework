...
import com.hulu.ap.apiframework.spi.CustomResourceConfigProvider;
...
public class ResourceContextHandler implements ContextHandlerBuilder {
     ...
     */
    public static final String[] DEFAULT_PACKAGES = new String[]{"com.hulu", "io.swagger.jaxrs.listing"};
